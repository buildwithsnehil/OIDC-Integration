...
namespace OIDCIntegration\Guards;

use OIDCIntegration\LdapService;
use OIDCIntegration\RegistrationService;
use OIDCIntegration\Exceptions\JsonDebugException;
use OIDCIntegration\Exceptions\LdapException;
use OIDCIntegration\Exceptions\LoginAttemptEmailNeededException;
use OIDCIntegration\Exceptions\LoginAttemptException;
use OIDCIntegration\Exceptions\UserRegistrationException;
...
class LdapSessionGuard extends ExternalBaseSessionGuard
{
     ...
     * @param bool  $remember
     *
     * @throws LdapException*@throws \OIDCIntegration\Exceptions\JsonDebugException
