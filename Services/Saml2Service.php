...
use OIDCIntegration\Exceptions\SamlException;
use OIDCIntegration\Exceptions\StoppedAuthenticationException;
...
class Saml2Service
{
    ...
    public function processSlsResponse(?string $requestId): string
    {
        ...
        $defaultOIDCRedirect = $this->loginService->logout();

        return $samlRedirect ?? $defaultOIDCRedirect;
    }
    ...
    /**
     * Get the value to use as the external id saved in OIDCIntegration
     * used to link the user to an existing OIDCIntegration DB user.
     */
